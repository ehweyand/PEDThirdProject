...
public class MainTres {
     ...
     */
    private static double calculaDistancia(Coordinates c, Coordinates f) {
        double first = Math.pow((c.getLatitude() - c.getLongitude()), 2)
                + Math.pow((f.getLatitude() - f.getLongitude()), 2);
